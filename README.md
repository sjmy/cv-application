...
Built with React. Enter CV details in the forms on the left and see a formatted CV displayed on the right. Includes a section for education, work experience, and a profile. Additional section can be added to the sidebar as needed. Downloads/prints the display CV.
